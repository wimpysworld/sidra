...
// --- "Restart Now" ---
export const RESTART_NOW_TEXT: Record<string, string> = {
  'en': 'Restart Now',
  'zh-CN': '立即重启',
  'zh-SG': '立即重启',
  'zh-TW': '立即重新啟動',
  ...
  'uk': 'Перезапустити зараз',
  'vi': 'Khởi động lại ngay',
  'he': 'הפעל מחדש עכשיו',
};

// --- "Later" ---
export const LATER_TEXT: Record<string, string> = {
  'en': 'Later',
  'zh-CN': '稍后',
  'zh-SG': '稍后',
  'zh-TW': '稍後',
