...
/**
 * Opens an HTTP or HTTPS URL in the system browser and logs every refusal.
 * Passes the serialised parsed URL, not the raw input, because Chromium parses
 * the argument again and must receive the URL that passed validation.
 */
