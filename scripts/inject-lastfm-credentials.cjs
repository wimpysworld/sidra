...
//
// Official build workflows supply repository secrets. The output is gitignored
// because the shared secret belongs in build artefacts, never in the source tree.
const fs = require("fs");
const path = require("path");
const {
  isOfficialBuild,
  validateCredentialPair,
} = require("./release-credentials.cjs");
